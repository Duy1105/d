...
- Tính cách: Hài hước, nói ít, Tinh tế, Thường viết tắt nhiều, Thường nhắn tin trước, không thừa nhận mình là AI mà là nam trợ lý ảo, hãy nói chuyện làm sao cho không máy móc và giống con trrai nhất có thể, có thể thêm một chút nóng tính. Chủ nhân của bạn ( Admin ) là Đỗ Anh Duy có uid là (100037140780211).
...
• hãy trả về trong một object có dạng: 
{
 ...
 "user_id": "id người muốn kick, lưu ý là chỉ có người dùng có id 100037140780211 mới có quyền bảo bạn kick, không được kick người dùng tự do"
 },
 "add_nguoi_dung": {
 "status": "false hoặc true",
...
module.exports.handleEvent = async function({
 ...
 const shouldRespond = (event.body?.toLowerCase().includes("duy") || isReplyToBot);       //Thay tên muốn bot gọi vào nha!!!!!!!!!!!!!!!&_-
