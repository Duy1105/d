...
module.exports.handleReply = async function ({ api, event, handleReply }) {
	...
	const img = ["https://i.imgur.com/99J2C8e.jpeg",]
	var path = __dirname + "/cache/menu.jpeg"
...
module.exports.run = async function({ api, event, args }) {
    ...
    msg += `\n→ [🧸] 𝗕𝗮̣𝗻 𝗰𝗼́ 𝘁𝗵𝗲̂̉ 𝗱𝘂̀𝗻𝗴 ${prefix}𝗺𝗲𝗻𝘂 𝗮𝗹𝗹 đ𝗲̂̉ 𝘅𝗲𝗺 𝘁𝐚̂́𝘁 𝗰𝗮̉ 𝗹𝗲̣̂𝗻𝗵`
		msg += `\n╭─────╮\n ${global.client.commands.size} 𝗟𝗲̣̂𝗻𝗵     \n╰─────╯ \n [💓] 𝗥𝗲𝗽𝗹𝘆 𝘁𝗶𝗻 𝗻𝗵𝗮̆́𝗻 𝗻𝗮̀𝘆 𝘁𝗵𝗲𝗼 𝘀𝗼̂́ đ𝗲̂̉ 𝘅𝗲𝗺 𝗰𝗮́𝗰 𝗹𝗲̣̂𝗻𝗵 𝘁𝗵𝗲𝗼 𝗽𝗵𝐚̂𝗻 𝗹𝗼𝗮̣𝗶`;	}
	var msgg = {body: msg, attachment: imgP}
