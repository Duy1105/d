module.exports.config = {
    ...
    version: "2.0.1",
    hasPermssion: 0,
    credits: "D-Jukie (Mod, Update by TuấnDz)",
...
module.exports.onLoad = async () => {
    ...
    if (!fs.existsSync(dir + "pokemon.json")) (await axios({
            url: "https://raw.githubusercontent.com/TuanDeepTry-14072003/pokemon/mainV2/pokemon.json",
            method: 'GET',
            responseType: 'stream'
    ...
    switch (args[0]) {
        ...
        case "-r": { 
            if (!existsSync(path)) {
                ...
                return api.sendMessage("⛩====[ 𝐏𝐎𝐊𝐄𝐌𝐎𝐍 ]=====⛩\n\n𝗧𝗮̣𝗼 𝘁𝗮̀𝗶 𝗸𝗵𝗼𝗮̉𝗻 𝗣𝗼𝗸𝗲𝗺𝗼𝗻 𝘁𝗵𝗮̀𝗻𝗵 𝗰𝗼̂𝗻𝗴\n𝗕𝗮̂́𝗺 🐧𝗽𝗼𝗸𝗲𝗺𝗼𝗻 𝘀𝗵𝗼𝗽 𝗺𝘂𝗮 𝗽𝗼𝗸𝗲𝗺𝗼𝗻", threadID, messageID);
            }
            else return api.sendMessage("⛩====[ 𝐏𝐎𝐊𝐄𝐌𝐎𝐍 ]=====⛩\n\n𝗕𝗮̣𝗻 𝗰𝗼́ 𝘁𝗮̀𝗶 𝗸𝗵𝗼𝗮̉𝗻 𝗣𝗼𝗸𝗲𝗺𝗼𝗻 𝗿𝗼̂̀𝗶\n𝗛𝗮̃𝘆 𝗰𝗵𝗶𝗻𝗵 𝗽𝗵𝘂̣𝗰 𝗰𝗮́𝗰 𝗸𝗲̉ 𝘁𝗵𝘂̀ 𝗻𝗮̀𝗼", threadID, messageID);
            break;
        }
        case 'rank': {
        ...
        case 'info':
        case '-i': {
            if (!existsSync(path)) { return api.sendMessage('⛩====[ 𝐏𝐎𝐊𝐄𝐌𝐎𝐍 ]=====⛩\n\n𝗕𝗮̣𝗻 𝗰𝗵𝘂̛𝗮 𝘁𝗮̣𝗼 𝘁𝗮̀𝗶 𝗸𝗵𝗼𝗮̉𝗻 𝗣𝗼𝗸𝗲𝗺𝗼𝗻\n𝗡𝗵𝗮̣̂𝗽 🐧𝗽𝗼𝗸𝗲𝗺𝗼𝗻 -𝗿 𝘁𝗮̣𝗼 𝘁𝗮̀𝗶 𝗸𝗵𝗼𝗮̉𝗻', threadID, messageID); }
  ...
  const { threadID, messageID } = event;
   return api.sendMessage({body: "💸====[ 𝐏𝐎𝐊𝐄𝐌𝐎𝐍 ]====💸\n\n🍗 𝟭/ 𝗠𝘂𝗮 𝘁𝗵𝘂̛́𝗰 𝗮̆𝗻 𝗰𝗵𝗼 𝗣𝗼𝗸𝗲𝗺𝗼𝗻.\n🦄 𝟮/ 𝗕𝗮́𝗻 𝗣𝗼𝗸𝗲𝗺𝗼𝗻.\n🔥 𝟯/ 𝗖𝘂̛𝗼̛̀𝗻𝗴 𝗵𝗼́𝗮 𝘀𝘂̛́𝗰 𝗺𝗮̣𝗻𝗵. (𝗯𝗼̉ 𝗿𝗮 𝟳𝟬𝟬𝟬𝟬$ 𝘀𝗼̂́ 𝘁𝗶𝗲̂̀𝗻 đ𝗲̂̉ 𝘁𝗮̆𝗻𝗴 𝟰𝟬% 𝘀𝘂̛́𝗰 𝗺𝗮̣𝗻𝗵 𝗰𝗵𝗼 𝟭 𝗽𝗼𝗸𝗲𝗺𝗼𝗻).\n💌 𝟰/ 𝗠𝘂𝗮 𝗿𝘂̛𝗼̛𝗻𝗴 𝗵𝗲𝘅𝘁𝗲𝗰𝗵 𝗿𝗮 𝗻𝗴𝗮̂̃𝘂 𝗻𝗵𝗶𝗲̂𝗻 𝟭 𝗽𝗼𝗸𝗲𝗺𝗼𝗻.\n\n🧐 𝗥𝗲𝗽𝗹𝘆 𝘁𝗶𝗻 𝗻𝗵𝗮̆́𝗻 𝗻𝗮̀𝘆 𝘃𝗼̛́𝗶 𝗹𝘂̛̣𝗮 𝗰𝗵𝗼̣𝗻 𝗰𝘂̉𝗮 𝗯𝗮̣𝗻.",attachment: (picture)
        ...
        case 'solo': {
            if (!existsSync(path)) { return api.sendMessage('⛩====[ 𝐏𝐎𝐊𝐄𝐌𝐎𝐍 ]=====⛩\n\n𝗕𝗮̣𝗻 𝗰𝗵𝘂̛𝗮 𝘁𝗮̣𝗼 𝘁𝗮̀𝗶 𝗸𝗵𝗼𝗮̉𝗻 𝗣𝗼𝗸𝗲𝗺𝗼𝗻\n𝗡𝗵𝗮̣̂𝗽 🐧𝗽𝗼𝗸𝗲𝗺𝗼𝗻 -𝗿 𝘁𝗮̣𝗼 𝘁𝗮̀𝗶 𝗸𝗵𝗼𝗮̉𝗻', threadID, messageID); }
            const user = require('./pokemon/datauser/' + `${senderID}.json`);
            if(user.pet.length == 0) return api.sendMessage('⛩====[ 𝐏𝐎𝐊𝐄𝐌𝐎𝐍 ]=====⛩\n\n𝗕𝗮̣𝗻 𝗰𝗵𝘂̛𝗮 𝗰𝗼́ 𝗣𝗼𝗸𝗲𝗺𝗼𝗻 𝗸𝗵𝗼̂𝗻𝗴 𝘁𝗵𝗲̂̉ 𝘁𝗵𝗮𝗺 𝗴𝗶𝗮\n𝗡𝗵𝗮̣̂𝗽 🐧𝗽𝗼𝗸𝗲𝗺𝗼𝗻 𝘀𝗵𝗼𝗽 𝘃𝗮̀ 𝗺𝘂𝗮 𝗣𝗼𝗸𝗲𝗺𝗼𝗻 𝗻𝗵𝗲́', threadID, messageID)
            ...
            switch (args[1]) {
                ...
                case '-c': {
                    ...
                    return api.sendMessage({body:`⛩=[ 𝐏𝐎𝐊𝐄𝐌𝐎𝐍 𝐒𝐎𝐋𝐎 ]=⛩\n\n🎉 𝐇𝐨𝐚̀𝐧 𝐭𝐡𝐚̀𝐧𝐡 𝐭𝐚̣𝐨 𝐦𝐚𝐩 𝐏𝐊, 𝐬𝐭𝐚𝐫𝐭 𝐤𝐡𝐢 𝐜𝐨́ 𝟐 𝐭𝐡𝐚̀𝐧𝐡 𝐯𝐢𝐞̂𝐧 𝐭𝐡𝐚𝐦 𝐠𝐢𝐚.\n👤 [ 𝟏/𝟐 ] 𝐩𝐥𝐚𝐲𝐞𝐫\n👉 𝐉𝐨𝐢𝐧: 𝐩𝐨𝐤𝐞𝐦𝐨𝐧 𝐬𝐨𝐥𝐨 𝐣𝐨𝐢𝐧/-𝐣`, attachment: createReadStream(__dirname + `/pokemon/pokemonpk.jpg`)}, threadID, messageID);
                } 
                case 'join':
                case '-j': {
                    if (!global.pokemon.has(threadID)) return api.sendMessage('⛩=[ 𝐏𝐎𝐊𝐄𝐌𝐎𝐍 𝐒𝐎𝐋𝐎 ]=⛩\n\n𝗡𝗵𝗼́𝗺 𝗻𝗮̀𝘆 𝗵𝗶𝗲̣̂𝗻 𝘁𝗮̣𝗶 𝗰𝗵𝘂̛𝗮 𝘁𝗮̣𝗼 𝗺𝗮𝗽 𝗻𝗮̀𝗼 ⚠\n𝗛𝗮̃𝘆 𝘁𝗮̣𝗼 𝗺𝗮𝗽 𝗻𝗲̂́𝘂 𝗺𝘂𝗼̂́𝗻 𝘀𝗼𝗹𝗼\n𝗡𝗵𝗮̣̂𝗽 /𝗽𝗼𝗸𝗲𝗺𝗼𝗻 𝘀𝗼𝗹𝗼 -𝗰 𝘃𝗮̀ 𝘁𝗮̣𝗼 𝗺𝗮𝗽 ', threadID, messageID);
                    if (gameThread.start == true) return api.sendMessage('⛩=[ 𝐏𝐎𝐊𝐄𝐌𝐎𝐍 𝐒𝐎𝐋𝐎 ]=⛩\n\n𝗠𝗮𝗽 𝘀𝗼𝗹𝗼 𝗼̛̉ 𝗻𝗵𝗼́𝗺 𝗻𝗮̀𝘆 𝘃𝗮̀𝗼 𝘁𝗿𝗮̣̂𝗻 𝗿𝗼̂̀𝗶 ⚠', threadID, messageID);
                    if (gameThread.player.find(i => i.userID == senderID)) return api.sendMessage('⛩=[ 𝐏𝐎𝐊𝐄𝐌𝐎𝐍 𝐒𝐎𝐋𝐎 ]=⛩\n\n𝗕𝗮̣𝗻 𝘃𝘂̛̀𝗮 𝘃𝗮̀𝗼 𝘁𝗿𝗮̣̂𝗻 𝘁𝘂̛̀ 𝘁𝗿𝘂̛𝗼̛́𝗰 𝗿𝗼̂̀𝗶 ⚠', threadID, messageID);
                    var name = await Users.getNameUser(senderID);
                    gameThread.player.push({ name, userID: senderID, choose: { status: false, msg: null } });
                    if(gameThread.player.length > 2) return api.sendMessage('⛩=[ 𝐏𝐎𝐊𝐄𝐌𝐎𝐍 𝐒𝐎𝐋𝐎 ]=⛩\n\n𝗦𝗼̂́ 𝗻𝗴𝘂̛𝗼̛̀𝗶 𝘁𝗵𝗮𝗺 𝗴𝗶𝗮 𝘃𝗮̀𝗼 𝗺𝗮𝗽 𝗻𝗮̀𝘆 𝗵𝗶𝗲̣̂𝗻 𝗳𝘂𝗹𝗹 𝗿𝗼̂̀𝗶 ⚠', threadID, messageID);
                    gameThread.start = true;
                    global.pokemon.set(threadID, gameThread);
                    api.sendMessage('⛩=[ 𝐏𝐎𝐊𝐄𝐌𝐎𝐍 𝐒𝐎𝐋𝐎 ]=⛩\n\n🎉 𝐓𝐡𝐚𝐦 𝐠𝐢𝐚 𝐭𝐡𝐚̀𝐧𝐡 𝐜𝐨̂𝐧𝐠.\n👤𝟐/𝟐 𝐩𝐥𝐚𝐲𝐞𝐫\n🔥 𝐒𝐭𝐚𝐫𝐭 𝐦𝐚𝐩 𝐬𝐨𝐥𝐨 𝐬𝐚𝐮 𝟓𝐬', threadID, messageID);
                    setTimeout(() => { return api.sendMessage('⛩=[ 𝐏𝐎𝐊𝐄𝐌𝐎𝐍 𝐒𝐎𝐋𝐎 ]=⛩\n\n👾 𝐕𝐮𝐢 𝐥𝐨̀𝐧𝐠 𝐧𝐡𝐚̣̂𝐩 "𝐦𝐲 𝐩𝐨𝐤𝐞𝐦𝐨𝐧" 𝐯𝐚̀ 𝐫𝐞𝐩𝐥𝐲 𝐭𝐢𝐧 𝐧𝐡𝐚̆́𝐧 𝐧𝐚̀𝐲 𝐜𝐡𝐨̣𝐧 𝐩𝐨𝐤𝐞𝐦𝐨𝐧 𝐫𝐚 𝐜𝐡𝐢𝐞̂́𝐧 𝐭𝐫𝐮̛𝐨̛̀𝐧𝐠 !', threadID, messageID)}, 5000);
                    return
                }
                case "end":
                case "end":
                case "-e": {
                    if (!gameThread) return api.sendMessage('⛩=[ 𝐏𝐎𝐊𝐄𝐌𝐎𝐍 𝐒𝐎𝐋𝐎 ]=⛩\n\n𝗡𝗵𝗼́𝗺 𝗻𝗮̀𝘆 𝗰𝗵𝘂̛𝗮 𝘁𝗮̣𝗼 𝗺𝗮𝗽 𝗸𝗵𝗼̂𝗻𝗴 𝘁𝗵𝗲̂̉ 𝗵𝘂𝘆̉ ⚠', threadID, messageID);
                    if (gameThread.author != senderID) return api.sendMessage('⛩=[ 𝐏𝐎𝐊𝐄𝐌𝐎𝐍 𝐒𝐎𝐋𝐎 ]=⛩\n\n𝗕𝗮̣𝗻 𝗸𝗵𝗼̂𝗻𝗴 𝘁𝗵𝗲̂̉ 𝗵𝘂𝘆̉ 𝗺𝗮𝗽 𝗰𝘂̉𝗮 𝗻𝗴𝘂̛𝗼̛̀𝗶 𝗸𝗵𝗮́𝗰 𝘁𝗮̣𝗼 𝗿𝗮 ⚠', threadID, messageID);
                    global.pokemon.delete(threadID);
                    return api.sendMessage('🎉 𝐗𝐨𝐚́ 𝐦𝐚𝐩 𝐬𝐨𝐥𝐨 𝐏𝐨𝐤𝐞𝐦𝐨𝐧 𝐭𝐡𝐚̀𝐧𝐡 𝐜𝐨̂𝐧𝐠 !', threadID, messageID); 
                }
                default: {
                    return api.sendMessage('⛩=[ 𝐏𝐎𝐊𝐄𝐌𝐎𝐍 𝐒𝐎𝐋𝐎 ]=⛩\n\n👉 𝗧𝗮̣𝗼 𝗺𝗮𝗽 𝘀𝗼𝗹𝗼: create/-c\n👉 𝗧𝗵𝗮𝗺 𝗴𝗶𝗮 𝗺𝗮𝗽: join/-j\n👉 𝗞𝗲̂́𝘁 𝘁𝗵𝘂́𝗰 𝘁𝗿𝗮̣̂𝗻: end/-e', threadID, messageID);
                }
            }
        }
        case 'support': {
            return api.sendMessage('⛩====[ 𝐒𝐔𝐏𝐏𝐎𝐑𝐓 ]===⛩\n\n𝟭. 𝗟𝗶𝗲̂𝗻 𝗵𝗲̣̂ 𝗺𝘂𝗮 𝗔𝗣𝗜𝗞𝗘𝗬\n𝟮. 𝗚𝗼́𝗽 𝘆́ 𝘁𝘂̛𝗼̛̉𝗻𝗴, 𝘆𝗲̂𝘂 𝗰𝗮̂̀𝘂 𝘁𝗶́𝗻𝗵 𝗻𝗮̆𝗻𝗴\n𝟯. 𝗡𝗵𝗮̣̂𝗻 𝗚𝗜𝗙𝗖𝗢𝗗𝗘\n𝟰. 𝗡𝗵𝗮̣̂𝗽 𝗚𝗜𝗙𝗧𝗖𝗢𝗗𝗘', threadID, (error, info) => {
                global.client.handleReply.push({
                    name: this.config.name,
                    messageID: info.messageID,
                    author: event.senderID,
        ...
        default: { 
            return api.sendMessage({body:`⛩===[ 𝐏𝐎𝐊𝐄𝐌𝐎𝐍 ]====⛩\n\n👤 𝗧𝗮̣𝗼 𝘁𝗮̀𝗶 𝗸𝗵𝗼𝗮̉𝗻: register/-r\n📜 𝗟𝗶𝘀𝘁 𝗽𝗼𝗸𝗲𝗺𝗼𝗻: list/-l\n📌 𝗜𝗻𝗳𝗼 𝘂𝘀𝗲𝗿: info/-i\n💸 𝗖𝘂̛̉𝗮 𝗵𝗮̀𝗻𝗴: shop/-s\n🎒 𝗕𝗮 𝗹𝗼̂: bag/-b\n🔍 𝗧𝗶̀𝗺 𝗸𝗶𝗲̂́𝗺: search/find/-f\n⚔ 𝗖𝗵𝗶𝗲̂́𝗻 𝘁𝗿𝘂̛𝗼̛̀𝗻𝗴: solo -c/-j/-e\n💬 𝗛𝗼̂̃ 𝘁𝗿𝗼̛̣, 𝗴𝗶𝗳𝘁𝗰𝗼𝗱𝗲: support`, attachment: createReadStream(__dirname + `/pokemon/pokemon.png`)}, threadID, messageID);
        };
    }
}
module.exports.handleReply = async ({ event, api, Currencies, handleReply, Users }) => {
    ...
    switch (handleReply.type) {
        ...
        case 'spadmin': {
            switch (body) {
                ...
                case '2': {
                    ...
                    return api.sendMessage('👉 𝑽𝒖𝒊 𝒍𝒐̀𝒏𝒈 𝒓𝒆𝒑𝒍𝒚 𝒕𝒊𝒏 𝒏𝒉𝒂̆́𝒏 𝒏𝒂̀𝒚 𝒌𝒆̀𝒎 𝒏𝒐̣̂𝒊 𝒅𝒖𝒏𝒈 đ𝒆̂̉ 𝒈𝒖̛̉𝒊 𝒕𝒊𝒏 𝒏𝒉𝒂̆́𝒏 𝒕𝒐̛́𝒊 𝒂𝒅𝒎𝒊𝒏 𝒈𝒂𝒎𝒆', threadID, (error, info) => {
                        global.client.handleReply.push({
                            name: this.config.name,
                            messageID: info.messageID,
                            author: event.senderID,
                ...
                case '3': {
                    ...
                    return api.sendMessage('👉 𝐆𝐈𝐅𝐂𝐎𝐃𝐄 𝐓𝐀̂𝐍 𝐓𝐇𝐔̉:\n' + res.data.msg, threadID, messageID);
                }
                case '4': {
                    api.unsendMessage(handleReply.messageID)
                    return api.sendMessage('👉 𝑽𝒖𝒊 𝒍𝒐̀𝒏𝒈 𝒓𝒆𝒑𝒍𝒚 𝒕𝒊𝒏 𝒏𝒉𝒂̆́𝒏 𝒏𝒂̀𝒚 𝒗𝒐̛́𝒊 𝒏𝒐̣̂𝒊 𝒅𝒖𝒏𝒈 𝒍𝒂̀ 𝑮𝑰𝑭𝑻𝑪𝑶𝑫𝑬 𝒃𝒂̣𝒏 𝒏𝒉𝒂̣̂𝒏 𝒕𝒖̛̀ 𝒂𝒅𝒎𝒊𝒏', threadID, (error, info) => {
                        global.client.handleReply.push({
                            name: this.config.name,
                            messageID: info.messageID,
                            author: event.senderID,
        ...
        case 'message': {
            ...
            api.unsendMessage(handleReply.messageID)
            if(res.data.msg != true) return api.sendMessage('💬 𝑮𝒖̛̉𝒊 𝒕𝒊𝒏 𝒏𝒉𝒂̆́𝒏 𝒕𝒐̛́𝒊 𝒂𝒅𝒎𝒊𝒏 𝒈𝒂𝒎𝒆 𝒕𝒉𝒂̂́𝒕 𝒃𝒂̣𝒊', threadID, messageID);
            return api.sendMessage('💬 𝑮𝒖̛̉𝒊 𝒕𝒊𝒏 𝒏𝒉𝒂̆́𝒏 𝒕𝒐̛́𝒊 𝒂𝒅𝒎𝒊𝒏 𝒈𝒂𝒎𝒆 𝒕𝒉𝒂̀𝒏𝒉 𝒄𝒐̂𝒏𝒈', threadID, messageID);
        }
        case 'giftcode': {
            ...
            if(res.data.msg == false) return api.sendMessage('🧡 𝑺𝑨𝑰 𝑮𝑰𝑭𝑪𝑶𝑫𝑬, 𝑽𝑼𝑰 𝑳𝑶̀𝑵𝑮 𝑪𝑯𝑶̛̀ 𝑪𝑶𝑫𝑬 𝑴𝑶̛́𝑰', threadID, messageID);
            if(res.data.msg == 'fail') return api.sendMessage('🧡 𝑩𝒂̣𝒏 𝒏𝒉𝒂̣̂𝒏 𝒓𝒐̂̀𝒊 𝒏𝒆̂𝒏 𝒌𝒉𝒐̂𝒏𝒈 𝒕𝒉𝒆̂̉ 𝒏𝒉𝒂̣̂𝒏 𝒕𝒊𝒆̂́𝒑', threadID, messageID);
            api.unsendMessage(handleReply.messageID)
            const pathA = require("path");
            const path = pathA.join(__dirname, 'pokemon', 'datauser', `${senderID}.json`);
            const user = require('./pokemon/datauser/' + `${senderID}.json`);
