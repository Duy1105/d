...
module.exports.onLoad = () => {
  ...
  const dirMaterial1 = __dirname + `/cache/`;
  if (!fs.existsSync(dirMaterial1 + "cache")) fs.mkdirSync(dirMaterial1, { recursive: true });
...
var msg = "";
    switch(handleReply.type) {
        case "choosee": {
            ...
            return api.sendMessage({body: `${msg}`, attachment: fs.createReadStream(__dirname + `/cache/ca1.png`)}, threadID, async () => {
